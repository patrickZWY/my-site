...
The private Rabbit Hole page is generated by Hakyll, converted into a
Worker-only generated module, and then removed from `_site` before upload:

```sh
stack exec site rebuild
node scripts/prepare-private-study-worker.js
```
